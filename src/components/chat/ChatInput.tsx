          ...
          {(images.length > 0 || files.length > 0) && (
            <>
              <div className="flex gap-2 p-3 pb-2 flex-wrap">
                ...
                {files.map((file, idx) => (
                  <div key={`file-${idx}`} className="flex items-center gap-2 px-3 py-1.5 bg-gray-800 border border-gray-700 rounded-lg text-xs text-gray-200 group">
                    ...
                    {file.truncated && <span className="text-yellow-400">截断</span>}
                    <button
